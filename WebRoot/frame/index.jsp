...
<html>
  ...
  <frameset rows="60,*,50"  frameborder="yes" border="1" noresize>
	  ...
	  <frame src="<%=path %>/frame/admin_bottom.jsp" noresize="noresize" frameborder="2" name="topFrame" scrolling="no" marginwidth="0" marginheight="0" />
  </frameset>
  <noframes>
  <body></body>
    </noframes>

	 ...
	 <tr><td>
		<table id="table-data-inner" cellspacing="0">
			...
			<tr>
				<td>
				部门名称：
					<input type="text" name="deptBean.deptName" id="dept_name" value="${deptBean.deptName}" /> 
				上级部门:
					<input type="text" name="deptBean.deptManager" id="dept_manager" value="${deptBean.deptManager}" /> 
                         	 <!--                                                   
                                                                                 修改时间:

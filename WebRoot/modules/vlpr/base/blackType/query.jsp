...
<body>
		...
		<form action="BlackTypeAction?" method="post" id="mainForm" >
			<table id="table-data-outter">
				<tr>
					...
					黑车类型 :<input type="text" name="blackType.typeName"  value="${blackType.typeName }" />
									...
									<script>
										function ResetForm(){
											$("input[name='blackType.userCode']").val("");
											$("#mainForm").submit();
										}
									</script>
									&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<div id="list_div">
			<table id="table-view" cellpadding="0" cellspacing="1">
				<tr class="row-header">
					...
					<td ondblclick="return sortQuery('blackType.typeName')" class="title-header" style="width:120px;" > 黑车类型</td>  
					<td ondblclick="return sortQuery('blackType.lastUpdate')" class="title-header" style="width:120px;" > 时间 </td>  
					<td ondblclick="return sortQuery('blackType.status')" class="title-header" style="width:120px;" > 状态 </td>  

...
<body>
		...
		<form action="AlarmConfigAction?" method="post" id="mainForm" >
			<table id="table-data-outter">
				<tr>
					...
					告警代码 :<input type="text" name="alarmConfig.alertCode"  value="${alarmConfig.alertCode }" />
					告警名称 :<input type="text" name="alarmConfig.alertName"  value="${alarmConfig.alertName }" />
					告警声音 :<input type="text" name="alarmConfig.wavUrl"  value="${alarmConfig.wavUrl }" />
									...
									<script>
										function ResetForm(){
											$("input[name='alarmConfig.userCode']").val("");
											$("#mainForm").submit();
										}
									</script>
									&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<div id="list_div">
			<table id="table-view" cellpadding="0" cellspacing="1">
				<tr class="row-header">
					...
					<td ondblclick="return sortQuery('alarmConfig.alertCode')" class="title-header" style="width:120px;" > 告警代码 </td>  
					<td ondblclick="return sortQuery('alarmConfig.alertName')" class="title-header" style="width:120px;" > 告警名称 </td>  
					<td ondblclick="return sortQuery('alarmConfig.wavUrl')" class="title-header" style="width:120px;" > 告警声音 </td>  
					<td ondblclick="return sortQuery('alarmConfig.status')" class="title-header" style="width:120px;" > 状态</td>  
				...
				<s:iterator id="l" value="list" status="index">
					...
					<tr class="<s:property value='var_class' />"
						...
						<td align="center">
							...
							<td align="center">
							<s:property value="#l.alertCode" />
						</td>
								<td align="center">
							<s:property value="#l.alertName" />
						</td>
								<td align="center">
							<script>
								var object="";
								if(document.all){
									object = "<embed id=player src=\"${l.wavUrl}\"  ";
									object += "console=LonelyStreet controls=ControlPanel autostart=false ></embed> "; 
								}else{
									object = "<audio id=player controls=controls src=\"${l.wavUrl}\" >";
									object += "<source /> </audio>";
								}

...
<body>
		...
		<form action="CarExtAction?" method="post" id="mainForm" >
			<table id="table-data-outter">
				<tr>
					...
					车牌 :<input type="text" name="carExt.plate"  value="${carExt.plate }" />
					车牌类型:<input type="text" name="carExt.plateType"  value="${carExt.plateType }" />
									...
									<script>
										function ResetForm(){
											$("input[name='carExt.userCode']").val("");
											$("#mainForm").submit();
										}
									</script>
									&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<div id="list_div">
			<table id="table-view" cellpadding="0" cellspacing="1">
				<tr class="row-header">
					...
					<td ondblclick="return sortQuery('carExt.plate')" class="title-header" style="width:120px;" > 车牌 </td>  
					<td ondblclick="return sortQuery('carExt.plateType')" class="title-header" style="width:120px;" > 车牌类型 </td>  
					<td ondblclick="return sortQuery('carExt.plateColor')" class="title-header" style="width:120px;" > 车牌颜色 </td>  
					<td ondblclick="return sortQuery('carExt.carColor')" class="title-header" style="width:120px;" > 车辆颜色 </td>  
					<td ondblclick="return sortQuery('carExt.carLogo')" class="title-header" style="width:120px;" > 车标 </td>  
					<td ondblclick="return sortQuery('carExt.carFrameNum')" class="title-header" style="width:120px;" > 车架号 </td>  
					<td ondblclick="return sortQuery('carExt.engineNum')" class="title-header" style="width:120px;" > 发动机号 </td>  
					<td ondblclick="return sortQuery('carExt.lastUpdate')" class="title-header" style="width:120px;" > 更新时间 </td>  
					<td ondblclick="return sortQuery('carExt.status')" class="title-header" style="width:120px;" > 状态 </td>  

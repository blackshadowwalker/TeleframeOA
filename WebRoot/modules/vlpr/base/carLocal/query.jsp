...
<body>
		...
		<form action="CarLocalAction?" method="post" id="mainForm" >
			<table id="table-data-outter">
				<tr>
					...
					车牌 :<input type="text" name="carLocal.plate"  value="${carLocal.plate }" />
					车牌类型:<input type="text" name="carLocal.plateType"  value="${carLocal.plateType }" />
									...
									<script>
										function ResetForm(){
											$("input[name='carLocal.userCode']").val("");
											$("#mainForm").submit();
										}
									</script>
									&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<div id="list_div">
			<table id="table-view" cellpadding="0" cellspacing="1" >
				<tr class="row-header">
					...
					<td ondblclick="return sortQuery('carLocal.plate')" class="title-header" style="width:100px;"> 车牌 </td>  
					<td ondblclick="return sortQuery('carLocal.plateType')" class="title-header" style="width:120px;" > 车牌类型 </td>  
					<td ondblclick="return sortQuery('carLocal.plateColor')" class="title-header" style="width:80px;" > 车牌颜色 </td>  
					<td ondblclick="return sortQuery('carLocal.carColor')" class="title-header" style="width:80px;" > 车辆颜色 </td>  
					<td ondblclick="return sortQuery('carLocal.carType')" class="title-header" style="width:120px;" > 车辆类型</td>  
					<td ondblclick="return sortQuery('carLocal.carLogo')" class="title-header" style="width:80px;" > 车标 </td>  
					<td ondblclick="return sortQuery('carLocal.carFrameNum')" class="title-header" style="width:120px;" > 车架号 </td>  
					<td ondblclick="return sortQuery('carLocal.engineNum')" class="title-header" style="width:120px;" > 发动机号 </td>  
					<td ondblclick="return sortQuery('carLocal.lastUpdate')" class="title-header" style="width:100px;" > 更新时间 </td>  

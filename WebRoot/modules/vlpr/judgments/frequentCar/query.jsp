		...
		<form action="${action}?&page.pageSize=${page.pageSize}" method="post" id="mainForm" >
			<table id="table-data-outter">
				...
				<div class="ConditionFiled">
					...
					<span class=titlelabel>出现频率不小于:</span> 
						<select name="resultCar.count" >
		...
		<div id="list_div">
			<table id="table-view" cellpadding="0" cellspacing="1" style="width:1100px;"  >
				<tr class="row-header">
					...
					<td ondblclick="return sortQuery('resultCar.confidence')" class="title-header" style="width:80px;" > 出现次数</td>  
					...
					<td ondblclick="return sortQuery('resultCar.deviceId')" class="title-header" style="width:300px;" > 设备 </td>  
					<td ondblclick="return sortQuery('resultCar.status')" class="title-header" style="width:80px;" > 状态 </td>  

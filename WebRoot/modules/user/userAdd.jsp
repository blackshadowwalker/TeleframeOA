						...
						<table id="table-data-inner" cellspacing="1">
							...
							<tr>
								...
								<td width="30%" class="field-content">
									<s:textfield id="rname" name="userInfo.userPasswd" maxlength="30"></s:textfield></td>
							</tr>
							<tr>
								<td width="10%" class="field-title">用户生日:</td>
								<td width="30%" class="field-content">
									<s:textfield id="rname" name="userInfo.userBirth" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" readonly="true" cssClass="Wdate"></s:textfield>
								</td>
							</tr>
							<tr>
